    ...
    .left-side, .main-sidebar {
      ...
      tabsetPanel(
        ...
        tabPanel(
          ...
          tags$div(
            ...
            tags$div(list(
              ...
              br(),
              a(Href = "http://dx.doi.org/10.1177/15554120211017036", "DOI: 10.1177/15554120211017036"),
              br()
            )),
            br()
          ),value = 0),
        ...
        tabPanel(
          ...
          p(
            "Below, the data in these graphs are searchable through the provided datatable."
          ),
          br(),
        ...
        tabPanel(
          ...
          br(),
          p(
            "The interactive map below currently only displays the top 11 countries of 2019 and 2020, ranked by video game revenue. Eleven countries are displayed, as one country changed on the Top 10 list between the 2 years. More data points (countries) will be added once we can gain access to more data."
          ),
          p(
        ...
        tabPanel(
          ...
          br(),
          p(
            "In the graph below, displayed is list of games that were delayed between 2019 and 2022. All data points here were selected from a collection of titles due to data completeness. Nonetheless, a simple pattern appears, more games were delayed during 2020 through 2022 than in 2019, reflecting the impact of the Covid-19 pandemic."
          ),
          br(),
          plotlyOutput("dly", height = "650px"),
          br(),
          p(
            "This graph displays the same information as above, but is reframed as days delayed, instead of dates delayed."
          ),
          br(),
          ...
          p(
            "Each selection will display the distribution of those who responded yes/no to the question whether playing video games during the pandemic affected their mental health. Of those who responded yes, the distribution of positive/negative impacts will be visible."
          ),
          br(),
          h3("Impact of Gaming on Mental Health During Covid-19"),
          br(),
