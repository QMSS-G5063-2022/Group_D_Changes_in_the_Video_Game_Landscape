...
wc2019 <-
  wordcloud2(df_2019, size=0.4, shape='circle', color='random-light', backgroundColor = 'black', gridSize=2.5 ,rotateRatio = 0.85)

#wc2019 <- wordcloud2Output(wc2019)

wc2020 <-
  wordcloud2(df_2020, size=0.4, shape='triangle-forward', color='random-light', backgroundColor = 'black', gridSize=2.5 ,rotateRatio = 0.85)

wc2021 <-
  wordcloud2(df_2021, size=0.4, shape='pentagon', color='random-light', backgroundColor = 'black', gridSize=2.5 ,rotateRatio = 0.85)
    ...
    sidebarLayout(
      ...
      mainPanel(
          ...
          tabPanel(
            ...
            h4("Verbatim text output"),
            br(),
            wordcloud2Output('wordcloud2019'),
            h4("Verbatim text output"),
            br(),
            wordcloud2Output('wordcloud2020'),
            h4("Verbatim text output"),
            br(),
            wordcloud2Output('wordcloud2021'),
            br()
          )
                 )
               ) #main panel
...
# output 8: delay
 ...
 #output 13: wordcloud
 output$wordcloud2019 <- renderWordcloud2({
   wc2019
   })
 
 output$wordcloud2020 <- renderWordcloud2({
   wc2020
   })
 
 output$wordcloud2021 <- renderWordcloud2({
   wc2021
   })
}
