      ...
      mainPanel(
          ...
          # Game Counts by Platforms tab
           tabPanel(
            ...
            br(),
            h4("The graph below indicates shows, over the last decade, the most popular platforms for game releases. Following a dip after 2019 the most popular release platforms were PC, Sony PS Consoles, and Xbox series"),
            br(),
            plotlyOutput("platform"),
            br(),
            h4("Console Sales Over Time"),
            h4("In addition, console sales data indicates that best selling piece of hardware since 2019 has been the Nintendo Switch. In late 2020 both the Xbox Series S and Play Station 5 were released and were very popular."),
          ...
          # release date delays tab         
            ...
            h4("Below we see the change in price of stocks for the top 10 Game companies. In March of 2020, approximately the time that covid-19 began to spread, there was a slight dip in stock prices followed by a steady rise, particularly for Microsoft."),
            plotlyOutput("stockplot"),
            br(),
