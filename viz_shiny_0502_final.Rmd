...
# shiny app
ui <- dashboardPage(
  dashboardHeader(title = "Changes in the Video Game Landscape",
                  titleWidth = 365),
  ...
  dashboardBody(
    ...
    tabsetPanel(
      ...
      tabPanel(
        "Project Overview",
        h3("Introduction"),
        h4("Intro of our project"),
        br(),
        h3("Group Members:"),
        # br(),
        h4("Shengkang 'Tobias' Zhou"),
        h5("Born and raised in a 'traditional' Chinese family, game was the forbidden fruit in his childhood. 
           However, his parent made a mistake when they bought him a Windows Machine in high school, because then he started
           to video games.
           His favorite genres are RPG and fantasy, and top three games are:"), 
        h5("Elder Scroll V: Skyrim  (bet on George Martin finish GOT before Bethesda release Elder Scroll VI)"),
        h5("Total War: Warhammer Series  (can only beat the campaign on the beginner difficulty)"),
      ...
      tabPanel(
        ...
        br(),
        h5("<-- User Instructions For This Tab:"),
        h6(
        ...
        br(),
        h4(
          "In this page, we compare the perception of games over the past 11 years (2011-2021) between the players and the
        ...
        h4(" 2. comparing the most popular genres over the years."),
        ...
        br(),
        h4("The score for genre is calculated by grouping games by their lable and taking the average of the groups.
           Every genre that has less than 30 games is dropped. The bubble size demonstrate number of games."),
        h4("As the graphs indicate, RPG, Atmospheric and Cooperative games is pupolar for both players and professional game critics 
           acorss the years. Tactical is the only genre that appears on top of the list for the metacritic, 
           while not appearing for the players. In 2015, tactical is the top genre rated by the metacritic, 
           including games like Metal Gear Solid V: The Phantom Pain and Wasteland 2: Director's Cut."),
        h4("Comedy is a genre that only appears in the player rating table. It includes games such as 
           Grand Thief Auto V, Half-life 2 and Portal 2. "),
        h4("The genres Violent and Gore are becoming more and more popular after 2018 and in recent years. 
           Games like Red Dead Redemption 2 and Seikiro: Shadow Die Twice receive overwhelmingly positive review by bothe the 
      ...
      tabPanel(
        "Games and Platforms",
        h4("Platform Game Counts Tracking Over Time"),
        br(),
        h4(
          "The graph below indicates shows, over the last decade, the most popular platforms for game releases. Following a dip after 2019 the most popular release platforms were PC, Sony PS Consoles, and Xbox series"
        ),
        br(),
        ...
        h4(
          "In addition, console sales data indicates that best selling piece of hardware since 2019 has been the Nintendo Switch. In late 2020 both the Xbox Series S and Play Station 5 were released and were very popular."
        ),
      ...
      tabPanel(
        ...
        h4(
          "Below we see the change in price of stocks for the top 10 Game companies. In March of 2020, approximately the time that covid-19 began to spread, there was a slight dip in stock prices followed by a steady rise, particularly for Microsoft."
        ),
        ...
        h4("Verbatim text output"),
        br(),
        h3("Impact of Covid-19 on Mental Health"),
        plotOutput("mho"),
        br(),
        value = 3
      ),
      ...
      # twitter data tab
      tabPanel(
        "Games and Twitter Sentiments",
        h3("2019 word cloud........might need better name"),
        # output line,
        br(),
        h3("2020 word cloud........might need better name"),
        # output line,
        br(),
        h3("2021 word cloud........might need better name"),
        # output line,
        br(),
        h4("analysis")
      )
